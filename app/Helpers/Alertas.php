...
class Alertas
{
    ...
    public static function mensagemApagaFoto($nome, $texto = null, $classe = null)
    {
        ...
        if (!empty($nome)) {
            ...
            if (!empty($texto) && empty($_SESSION[$nome])) {
                ...
                $classe = !empty($_SESSION[$nome . 'classe']) ? $_SESSION[$nome . 'classe'] : 'alert alert-success msg-texto';
                echo '<div class="' . $classe . '">' . $_SESSION[$nome] . '</div>';

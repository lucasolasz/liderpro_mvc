                                ...
                                <?php if ($_SESSION['linguagem_selecionada'] == "PT") { ?>
                                    <div class="dropdown-language">
                                        ...
                                        <div class="dropdown-language-content">
                                            <a href="<?= URL . "/Paginas/trocaLinguagem/?linguagem=PT" ?>"><span class="iconlang-PT" id="iconlang-PT"></span></a>
                                            <a href="<?= URL . "/Paginas/trocaLinguagem/?linguagem=ES" ?>"><span class="iconlang-ES" id="iconlang-ES"></span></a>
                                            <a href="<?= URL . "/Paginas/trocaLinguagem/?linguagem=EN" ?>"><span class="iconlang-EN" id="iconlang-EN"></span></a>
                                        </div>
                                    </div>

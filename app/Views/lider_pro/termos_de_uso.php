<div class="container p-5">
    ...
    <div class="row p-5">
        <div class="col-md-12 col-lg-12 d-flex  justify-content-center">
            <p class="lp-paragrafo-sublinhado">TERMOS DE USO</p>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <p class="lp-paragrafo">
                Por favor, é importante ler as regras de uso anteriormente a sua utilização.
                <br>
                Este website foi projetado e construído pela Liderpro Informática EIRELI com o objetivo de atender única e exclusivamente aos seus clientes. Todos os serviços e informações contidos neste website deverão ser utilizados conforme normas especificadas abaixo. Caso o usuário não concorde com as regras, ele não deverá acessar nenhuma das áreas deste website.
            </p>

<div class="container p-5">
    ...
    <div class="row py-5">
        <div class="col-md-6 col-lg-6 d-flex flex-column">
            ...
            <div class="d-flex justify-content-center mt-5">
                <ul class="list-unstyled w-100 lp-ul-assistencia">
                    <li class="lp-li-assistencia-titulo">Main Problemss</li>
                    <li>-The printer does not turn on!</li>
                    <li>-A paper has jammed inside the printer!</li>
                    <li>-How to install the ink/toner cartridge?</li>
                    <li>-The printer is all dirty with ink/toner inside!</li>
                    <li>-How to install a print server in the company?</li>
                    <li>-How to configure the printer on the wireless network (Wi-Fi)?</li>
                    <li>-How to know the ink/toner cartridge level?</li>
                    <li>-How to save printer ink/toner?</li>
                </ul>
            </div>
        </div>

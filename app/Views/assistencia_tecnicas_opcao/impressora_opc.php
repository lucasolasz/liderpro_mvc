        ...
        <div class="col-md-6 col-lg-6 d-flex flex-column">
            ...
            <div class="d-flex justify-content-center mt-5">
                <ul class="list-unstyled w-100 lp-ul-assistencia">
                    ...
                    <li>-A impressora não liga!</li>
                    <li>-Prendeu um papel dentro da impressora!</li>
                    <li>-Como instalar o cartucho de tinta/toner?</li>
                    <li>-A impressora está toda suja de tinta/toner por dentro!</li>
                    <li>-Como instalar um servidor de impressão na empresa?</li>
                    <li>-Como configurar a impressora na rede sem fio (Wi-Fi)?</li>
                    <li>-Como saber o nível do cartucho de tinta/toner?</li>
                    <li>-Como economizar tinta/toner da impressora?</li>
                </ul>
            </div>
        </div>
            ...
            <div class="d-flex flex-column ">
                ...
                <div class="row py-4">
                    ...
                    <div class="col-md-11 col-lg-11">
                        <p class="lp-paragrafo m-0">(21) 2526-8100</p>
                    </div>
                </div>

        ...
        <div class="col-md-6 col-lg-6 d-flex flex-column">
            ...
            <div class="d-flex justify-content-center mt-5">
                <ul class="list-unstyled w-100 lp-ul-assistencia">
                    ...
                    <li>-O projetor não liga!</li>
                    <li>-O projetor está esquentando muito!</li>
                    <li>-A lâmpada tá queimada!</li>
                    <li>-O projetor tá fazendo um barulho!</li>
                    <li>-Sai um ar muito quente do projetor!</li>
                    <li>-Como instala um projetor no teto?</li>
                    <li>-A carcaça do projetor rachou!</li>
                    <li>-A imagem projetada está turva!</li>
                </ul>
            </div>
        </div>

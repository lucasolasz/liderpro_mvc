        ...
        <div class="col-md-6 col-lg-6 d-flex flex-column">
            ...
            <div class="d-flex justify-content-center mt-5">
                <ul class="list-unstyled w-100 lp-ul-assistencia">
                    ...
                    <li>-Screen, Keyboard and other parts replacement</li>
            ...
            <div class="d-flex justify-content-center mt-5">
                <ul class="list-unstyled w-100 lp-ul-assistencia">
                    ...
                    <li>-The notebook does not turn on!</li>
                    <li>-The notebook has a virus!</li>
                    ...
                    <li>-I want to install a new part in the notebook!</li>
                    <li>-I want to back up my files/data!</li>
                    <li>-The notebook won't turn on!</li>
                    <li>-The notebook has a virus!</li>
                    <li>-The wireless network (Wi-Fi) is slow!</li>
                    <li>-The internet is not working!</li>
                    <li>-I lost my files/data!</li>

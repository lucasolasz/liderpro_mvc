<div class="container p-5">
    ...
    <div class="row py-5">
        <div class="col-md-6 col-lg-6 d-flex flex-column">
            <div>
                <img class="img-fluid" style="height: 200px; width: 300px" src="<?= URL . '/img/paginas/assistencia_tecnica/assistencia_tecnica_projetor.png' ?>" alt="">
            </div>
            ...
            <div class="d-flex justify-content-center mt-5">
                <ul class="list-unstyled w-100 lp-ul-assistencia">
                    ...
                    <li>-Reemplazo de lámpara</li>
                    <li>-Reparación de Piezas y Placas</li>
                    <li>-Instalación y desinstalación in situ</li>
                </ul>
            </div>
            ...
            <div class="d-flex justify-content-center mt-5">
                <ul class="list-unstyled w-100 lp-ul-assistencia">
                    ...
                    <li>-¡El proyector no enciende!</li>
                    <li>-¡El proyector se está calentando demasiado!</li>
                    <li>-¡La lámpara está quemada!</li>
                    <li>-¡El proyector está haciendo ruido!</li>
                    <li>-¡Sale aire muy caliente del proyector!</li>
                    <li>-¿Cómo se instala un proyector en el techo?</li>
                    <li>-¡La carcasa del proyector está rota!</li>
                    <li>-¡La imagen proyectada está borrosa!</li>
                </ul>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-6">
            ...
            <div class="d-flex flex-column ">
                ...
                <form name="emailAssistencia" id="emailAssistencia" method="POST" action="<?= URL ?>/EnvioEmail/enviarEmailAssistenciaProjetor" enctype="multipart/form-data">
                    <div class="p-2">

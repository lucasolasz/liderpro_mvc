<div class="container p-5">
    ...
    <div class="row py-5">
        <div class="col-md-6 col-lg-6 d-flex flex-column">
            <div>
                <img class="img-fluid" style="height: 200px; width: 300px" src="<?= URL . '/img/paginas/assistencia_tecnica/assistencia_tecnica_nobreak.png' ?>" alt="">
            </div>
            ...
            <div class="d-flex justify-content-center mt-5">
                <ul class="list-unstyled w-100 lp-ul-assistencia">
                    ...
                    <li>-O No-break não liga!</li>
                    <li>-O No-break não segura energia!</li>
                    <li>-O no-break está apitando!</li>
                    <li>-Os leds dos no-break estão piscando!</li>
                    <li>-O no-break está fazendo barulho!</li>
                    <li>-Como Instalar um no-breaks?</li>
                    <li>-Como se troca a bateria do no-break?</li>
                    <li>-Quais equipamentos não se ligam em no-breaks?</li>
                    <li>-Qual o no-break correto para os meus equipamentos?</li>
                </ul>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-6">
            ...
            <div class="d-flex flex-column ">
                ...
                <form name="emailAssistencia" id="emailAssistencia" method="POST" action="<?= URL ?>/EnvioEmail/enviarEmailAssistenciaNobreak" enctype="multipart/form-data">
                    <div class="p-2">

        ...
        <div class="col-md-6 col-lg-6 d-flex flex-column">
            ...
            <div class="d-flex justify-content-center mt-5">
                <ul class="list-unstyled w-100 lp-ul-assistencia">
                    ...
                    <li>-Tipo: AT, ATX, DTX ITX e EPS</li>
            ...
            <div class="d-flex justify-content-center mt-5">
                <ul class="list-unstyled w-100 lp-ul-assistencia">
                    ...
                    <li>-A fonte não liga!</li>
                    <li>-A fonte está com um barulho!</li>
                    <li>-A fonte queimou!</li>
                    <li>-Sai um ar muito quente da fonte!</li>
                    <li>-A fonte liga, mas o led não liga!</li>
                    <li>-O led liga, mas a fonte não liga!</li>
                    <li>-A ventoinha da fonte não gira!</li>
                    <li>-Qual é a fonte correta para o meu computador?</li>
                </ul>
            </div>
        </div>

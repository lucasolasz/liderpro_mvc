<div class="container p-5">
    ...
    <div class="row py-5">
        <div class="col-md-6 col-lg-6 d-flex flex-column">
            <div>
                <img class="img-fluid" style="height: 200px; width: 300px" src="<?= URL . '/img/paginas/assistencia_tecnica/assistencia_tecnica_fonte.png' ?>" alt="">
            </div>
            ...
            <div class="d-flex justify-content-center mt-5">
                <ul class="list-unstyled w-100 lp-ul-assistencia">
                    ...
                    <li>-Type: AT, ATX, DTX ITX and EPS</li>
            ...
            <div class="d-flex justify-content-center mt-5">
                <ul class="list-unstyled w-100 lp-ul-assistencia">
                    ...
                    <li>-The font does not turn on!</li>
                    <li>-The fountain is noisy!</li>
                    <li>-The fountain burned!</li>
                    <li>-Very hot air comes out of the fountain!</li>
                    <li>-The source turns on, but the led does not turn on!</li>
                    <li>-The led turns on, but the source does not turn on!</li>
                    <li>-The power supply fan does not spin!</li>
                    <li>-What is the correct font for my computer?</li>
                </ul>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-6">
            ...
            <div class="d-flex flex-column ">
                ...
                <form name="emailAssistencia" id="emailAssistencia" method="POST" action="<?= URL ?>/EnvioEmail/enviarEmailAssistenciaFonte" enctype="multipart/form-data">
                    <div class="p-2">

        ...
        <div class="col-md-6 col-lg-6 d-flex flex-column">
            ...
            <div class="d-flex justify-content-center mt-5">
                <ul class="list-unstyled w-100 lp-ul-assistencia">
                    ...
                    <li>-Calibración de Baterías</li>
                    <li>-Mantenimiento preventivo</li>
                    <li>-Mantenimiento Correctivo</li>
                    <li>-Contactar con Mantenimiento</li>
                    <li>-Evaluación técnica in situ</li>
                </ul>
            </div>
            ...
            <div class="d-flex justify-content-center mt-5">
                <ul class="list-unstyled w-100 lp-ul-assistencia">
                    ...
                    <li>-¡El UPS no enciende!</li>
                    <li>-¡El UPS no retiene energía!</li>
                    <li>-¡El UPS está emitiendo un pitido!</li>
                    <li>-¡Los LED del UPS están parpadeando!</li>
                    <li>-¡El UPS está haciendo ruido!</li>
                    <li>-¿Cómo instalar un UPS?</li>
                    <li>-¿Cómo se cambia la batería del UPS?</li>
                    <li>-¿Qué equipo no se conecta al UPS?</li>
                    <li>-¿Cuál es el UPS correcto para mi equipo?</li>
                </ul>
            </div>
        </div>

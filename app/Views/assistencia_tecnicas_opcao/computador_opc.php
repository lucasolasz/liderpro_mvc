<div class="container p-5">
    ...
    <div class="row py-5">
        <div class="col-md-6 col-lg-6 d-flex flex-column">
            <div>
                <img class="img-fluid" style="height: 200px; width: 300px" src="<?= URL . '/img/paginas/assistencia_tecnica/assistencia_tecnica_computador.png' ?>" alt="">
            </div>
            ...
            <div class="d-flex justify-content-center mt-5">
                <ul class="list-unstyled w-100 lp-ul-assistencia">
                    ...
                    <li>-O computador não liga!</li>
                    <li>-O computador está com vírus!</li>
                    ...
                    <li>-Quero instalar uma peça nova no computador!</li>
                    <li>-Quero fazer backup dos meus arquivos/dados!</li>
                </ul>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-6">
            ...
            <div class="d-flex flex-column ">
                ...
                <form name="emailAssistencia" id="emailAssistencia" method="POST" action="<?= URL ?>/EnvioEmail/enviarEmailAssistenciaComputador" enctype="multipart/form-data">
                    <div class="p-2">

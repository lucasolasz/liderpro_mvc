        ...
        <div class="col-md-6 col-lg-6 d-flex flex-column">
            ...
            <div class="d-flex justify-content-center mt-5">
                <ul class="list-unstyled w-100 lp-ul-assistencia">
                    ...
                    <li>-Calibration of Batteries</li>
            ...
            <div class="d-flex justify-content-center mt-5">
                <ul class="list-unstyled w-100 lp-ul-assistencia">
                    ...
                    <li>-The UPS does not turn on!</li>
                    <li>-The UPS does not hold power!</li>
                    <li>-The UPS is beeping!</li>
                    <li>-The UPS LEDs are flashing!</li>
                    <li>-The UPS is making noise!</li>
                    <li>-How to install a UPS?</li>
                    <li>-How do you change the UPS battery?</li>
                    <li>-What equipment does not connect to UPS?</li>
                    <li>-What is the correct UPS for my equipment?</li>
                </ul>
            </div>
        </div>

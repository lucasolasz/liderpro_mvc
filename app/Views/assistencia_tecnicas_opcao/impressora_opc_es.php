<div class="container p-5">
    ...
    <div class="row py-5">
        <div class="col-md-6 col-lg-6 d-flex flex-column">
            <div>
                <img class="img-fluid" style="height: 200px; width: 300px" src="<?= URL . '/img/paginas/assistencia_tecnica/assistencia_tecnica_impressora.png' ?>" alt="">
            </div>
            ...
            <div class="d-flex justify-content-center mt-5">
                <ul class="list-unstyled w-100 lp-ul-assistencia">
                    ...
                    <li>-Reparación de piezas, placas y fuentes</li>
                    <li>-Instalación de equipos</li>
                    <li>-Arrendamiento de impresoras</li>
                    <li>-Mantenimiento contractual</li>
                </ul>
            </div>
            ...
            <div class="d-flex justify-content-center mt-5">
                <ul class="list-unstyled w-100 lp-ul-assistencia">
                    ...
                    <li>-¡La impresora no enciende!</li>
                    <li>-¡Se ha atascado un papel dentro de la impresora!</li>
                    <li>-¿Cómo instalar el cartucho de tinta/tóner?</li>
                    <li>-¡La impresora está toda sucia con tinta/tóner adentro!</li>
                    <li>-¿Cómo instalar un servidor de impresión en la empresa?</li>
                    <li>-¿Cómo configurar la impresora en la red inalámbrica (Wi-Fi)?</li>
                    <li>-¿Cómo saber el nivel del cartucho de tinta/tóner?</li>
                    <li>-¿Cómo ahorrar tinta/tóner en la impresora?</li>
                </ul>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-6">
            ...
            <div class="d-flex flex-column ">
                ...
                <form name="emailAssistencia" id="emailAssistencia" method="POST" action="<?= URL ?>/EnvioEmail/enviarEmailAssistenciaImpressora" enctype="multipart/form-data">
                    <div class="p-2">

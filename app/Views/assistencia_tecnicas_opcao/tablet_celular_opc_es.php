        ...
        <div class="col-md-6 col-lg-6 d-flex flex-column">
            ...
            <div class="d-flex justify-content-center mt-5">
                <ul class="list-unstyled w-100 lp-ul-assistencia">
                    ...
                    <li>-Instalación de la aplicación - Aplicación</li>
                    <li>-Reparación de Android e IOS</li>
            ...
            <div class="d-flex justify-content-center mt-5">
                <ul class="list-unstyled w-100 lp-ul-assistencia">
                    ...
                    <li>-¡La tableta/teléfono no enciende!</li>
                    <li>-¡Tu tableta/teléfono tiene un virus!</li>
                    ...
                    <li>-¡Se rompió la pantalla!</li>
                    <li>-¡El teléfono se mojó!</li>
                </ul>
            </div>
        </div>

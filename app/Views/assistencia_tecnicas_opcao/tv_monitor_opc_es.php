        ...
        <div class="col-md-6 col-lg-6 d-flex flex-column">
            ...
            <div class="d-flex justify-content-center mt-5">
                <ul class="list-unstyled w-100 lp-ul-assistencia">
                    ...
                    <li>-Reemplazo de pantalla rota</li>
                    <li>-Calibración de imagen</li>
                    <li>-Instalación de video wall</li>
                    <li>-Modelos OLED, LED, LCD y Plasma</li>
                </ul>
            </div>
            ...
            <div class="d-flex justify-content-center mt-5">
                <ul class="list-unstyled w-100 lp-ul-assistencia">
                    ...
                    <li>-¡El televisor/monitor no enciende!</li>
                    <li>-¡El televisor/monitor tiene manchas en la pantalla!</li>
                    <li>-¡El sonido del televisor/monitor no funciona!</li>
                    <li>-¡La imagen del televisor/monitor está borrosa!</li>
                    <li>-¡El botón TV/monitor no funciona!</li>
                    <li>-¿Cómo configurar Internet en mi televisor?</li>
                    <li>-¿Cómo conectar la computadora a mi televisor?</li>
                    <li>-¿Cómo instalar el televisor/monitor en la pared?</li>
                </ul>
            </div>
        </div>

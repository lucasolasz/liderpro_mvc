<div class="container mb-5">
    ...
    <div class="row d-flex justify-content-start mt-5">
        <div class="col-md-6 d-flex flex-row">
            <div class="row">
                <div class="col">
                    <a class="btn d-flex justify-content-center align-items-center lp-btn-liderpro-info m-2 <?= $dados['tituloBreadcrumb'] == 'ordemAlfabetica' ? 'lp-btn-liderpro-info-active' : ''; ?>" href="<?= URL . '/Paginas/pesquisaAvancadaClienteAlfabetica' ?>" role="button">IN ALPHABETICAL ORDER</a>
                </div>
                <div class="col">
                    <a class="btn d-flex justify-content-center align-items-center lp-btn-liderpro-info m-2 <?= $dados['tituloBreadcrumb'] == 'ordemSegmento' ? 'lp-btn-liderpro-info-active' : ''; ?>" href="<?= URL . '/Paginas/pesquisaAvancadaClientePorSegmento' ?>" role="button">BY SEGMENT ORDER</a>
                </div>
            </div>
        </div>
        <div class="col-md-6 d-flex justify-content-end align-items-center">
            <div class="input-group">
                <input type="text" class="form-control" placeholder="Search by company name" id="pesquisarClienteSegmento">
    ...
    <div class="row mt-5">
        <div class="col-md-3">
            <h3 class="lp-titulo-paragrafo">SEGMENTS</h3>
        ...
        <div class="col-md-8 lp-container-logos-avancado m-3 overflow-auto" id="divResultadoAjaxPorSegmento">
            <p style="color: gray;" class="p-3">Choose a segment</p>
        </div>
    </div>

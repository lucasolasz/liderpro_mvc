...
<div class="container mt-5">
    <div class="row ">
        <div class="col">
            <p class="lp-paragrafo">Some <b>CUSTOMERS</b> that we have the opportunity to serve</p>
        </div>

        <div class="col d-flex  justify-content-end">
            <a class="lp-remove-decoration" href="<?= URL . '/Paginas/pesquisaAvancadaClienteAlfabetica' ?>">Advanced Customer Search</a>
        </div>
    </div>
...
<div class="container lp-container-logos p-5 mb-5">
    <div class="row" id="image-grid">
        <p style="color: gray;">Choose a segment</p>
    </div>
</div>

<div class="container mb-5">
    ...
    <div class="row d-flex justify-content-start mt-5">
        ...
        <div class="col-md-6 d-flex justify-content-end align-items-center">
            <div class="input-group">
                <input type="text" class="form-control" id="pesquisarClienteAlfabeto" placeholder="Search by company name">
    ...
    <div class="d-flex flex-column mt-5">
        ...
        <div class="lp-container-logos-avancado overflow-auto" id="divResultadoAjaxAlfabetica">
            <p style="color: gray;" class="p-3">Choose a filter option</p>
        </div>
    </div>

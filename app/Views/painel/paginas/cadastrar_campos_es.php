<div class="form-group mt-4">
    ...
    <input type="input" class="form-control" id="txtTitutoPaginaEs" name="txtTitutoPaginaEs">
...
<div class="form-group">
    ...
    <textarea class="form-control val-obrigatorio" id="txtTextPrincipalEs" name="txtTextPrincipalEs" rows="8" maxlength="800"></textarea>
</div>
                ...
                <div class="row p-4">
                    <div class="col-md-12 col-sm-12 col-lg-12">
                        <div class="form-group">
                            ...
                            <input type="input" class="form-control" name="txtNomeTab1Es" id="txtNomeTab1Es">
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group ml-4">
                                    ...
                                    <input type="input" class="form-control" name="txtTopico1Tab1Es" id="txtTopico1Tab1Es">
                                </div>
                                <div class="form-group ml-4">
                                    <label for="txtTopico2Tab1Es">Tópico 2 Tab 1 Espanhol</label>
                                    <input type="input" class="form-control" name="txtTopico2Tab1Es" id="txtTopico2Tab1Es">
                                </div>
                                <div class="form-group ml-4">
                                    <label for="txtTopico3Tab1Es">Tópico 3 Tab 1 Espanhol</label>
                                    <input type="input" class="form-control" name="txtTopico3Tab1Es" id="txtTopico3Tab1Es">
                                </div>
                                <div class="form-group ml-4">
                                    <label for="txtTopico4Tab1Es">Tópico 4 Tab 1 Espanhol</label>
                                    <input type="input" class="form-control" name="txtTopico4Tab1Es" id="txtTopico4Tab1Es">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group ml-4">
                                    <label for="txtTopico5Tab1Es">Tópico 5 Tab 1 Espanhol</label>
                                    <input type="input" class="form-control" name="txtTopico5Tab1Es" id="txtTopico5Tab1Es">
                                </div>
                                <div class="form-group ml-4">
                                    <label for="txtTopico6Tab1Es">Tópico 6 Tab 1 Espanhol</label>
                                    <input type="input" class="form-control" name="txtTopico6Tab1Es" id="txtTopico6Tab1Es">
                                </div>
                                <div class="form-group ml-4">
                                    <label for="txtTopico7Tab1Es">Tópico 7 Tab 1 Espanhol</label>
                                    <input type="input" class="form-control" name="txtTopico7Tab1Es" id="txtTopico7Tab1Es">
                                </div>
                                <div class="form-group ml-4">
                                    <label for="txtTopico8Tab1Es">Tópico 8 Tab 1 Espanhol</label>
                                    <input type="input" class="form-control" name="txtTopico8Tab1Es" id="txtTopico8Tab1Es">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row p-4">
                    <div class="col-md-12 col-sm-12 col-lg-12">
                        <div class="form-group">
                            ...
                            <input type="input" class="form-control" name="txtNomeTab2Es" id="txtNomeTab2Es">
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group ml-4">
                                    ...
                                    <input type="input" class="form-control" name="txtTopico1Tab2Es" id="txtTopico1Tab2Es">
                                </div>
                                <div class="form-group ml-4">
                                    <label for="txtTopico2Tab2Es">Tópico 2 Tab 2 Espanhol</label>
                                    <input type="input" class="form-control" name="txtTopico2Tab2Es" id="txtTopico2Tab2Es">
                                </div>
                                <div class="form-group ml-4">
                                    <label for="txtTopico3Tab2Es">Tópico 3 Tab 2 Espanhol</label>
                                    <input type="input" class="form-control" name="txtTopico3Tab2Es" id="txtTopico3Tab2Es">
                                </div>
                                <div class="form-group ml-4">
                                    <label for="txtTopico4Tab2Es">Tópico 4 Tab 2 Espanhol</label>
                                    <input type="input" class="form-control" name="txtTopico4Tab2Es" id="txtTopico4Tab2Es">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group ml-4">
                                    <label for="txtTopico5Tab2Es">Tópico 5 Tab 2 Espanhol</label>
                                    <input type="input" class="form-control" name="txtTopico5Tab2Es" id="txtTopico5Tab2Es">
                                </div>
                                <div class="form-group ml-4">
                                    <label for="txtTopico6Tab2Es">Tópico 6 Tab 2 Espanhol</label>
                                    <input type="input" class="form-control" name="txtTopico6Tab2Es" id="txtTopico6Tab2Es">
                                </div>
                                <div class="form-group ml-4">
                                    <label for="txtTopico7Tab2Es">Tópico 7 Tab 2 Espanhol</label>
                                    <input type="input" class="form-control" name="txtTopico7Tab2Es" id="txtTopico7Tab2Es">
                                </div>
                                <div class="form-group ml-4">
                                    <label for="txtTopico8Tab2Es">Tópico 8 Tab 2 Espanhol</label>
                                    <input type="input" class="form-control" name="txtTopico8Tab2Es" id="txtTopico8Tab2Es">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row p-4">
                    <div class="col-md-12 col-sm-12 col-lg-12">
                        <div class="form-group">
                            ...
                            <input type="input" class="form-control" name="txtNomeTab3Es" id="txtNomeTab3Es">
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group ml-4">
                                    ...
                                    <input type="input" class="form-control" name="txtTopico1Tab3Es" id="txtTopico1Tab3Es">
                                </div>
                                <div class="form-group ml-4">
                                    <label for="txtTopico2Tab3Es">Tópico 2 Tab 3 Espanhol</label>
                                    <input type="input" class="form-control" name="txtTopico2Tab3Es" id="txtTopico2Tab3Es">
                                </div>
                                <div class="form-group ml-4">
                                    <label for="txtTopico3Tab3Es">Tópico 3 Tab 3 Espanhol</label>
                                    <input type="input" class="form-control" name="txtTopico3Tab3Es" id="txtTopico3Tab3Es">
                                </div>
                                <div class="form-group ml-4">
                                    <label for="txtTopico4Tab3Es">Tópico 4 Tab 3 Espanhol</label>
                                    <input type="input" class="form-control" name="txtTopico4Tab3Es" id="txtTopico4Tab3Es">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group ml-4">
                                    <label for="txtTopico5Tab3Es">Tópico 5 Tab 3 Espanhol</label>
                                    <input type="input" class="form-control" name="txtTopico5Tab3Es" id="txtTopico5Tab3Es">
                                </div>
                                <div class="form-group ml-4">
                                    <label for="txtTopico6Tab3Es">Tópico 6 Tab 3 Espanhol</label>
                                    <input type="input" class="form-control" name="txtTopico6Tab3Es" id="txtTopico6Tab3Es">
                                </div>
                                <div class="form-group ml-4">
                                    <label for="txtTopico7Tab3Es">Tópico 7 Tab 3 Espanhol</label>
                                    <input type="input" class="form-control" name="txtTopico7Tab3Es" id="txtTopico7Tab3Es">
                                </div>
                                <div class="form-group ml-4">
                                    <label for="txtTopico8Tab3Es">Tópico 8 Tab 3 Espanhol</label>
                                    <input type="input" class="form-control" name="txtTopico8Tab3Es" id="txtTopico8Tab3Es">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row p-4">
                    <div class="col-md-12 col-sm-12 col-lg-12">
                        <div class="form-group">
                            ...
                            <input type="input" class="form-control" name="txtNomeTab4Es" id="txtNomeTab4Es">
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group ml-4">
                                    ...
                                    <input type="input" class="form-control" name="txtTopico1Tab4Es" id="txtTopico1Tab4Es">
                                </div>
                                <div class="form-group ml-4">
                                    <label for="txtTopico2Tab4Es">Tópico 2 Tab 4 Espanhol</label>
                                    <input type="input" class="form-control" name="txtTopico2Tab4Es" id="txtTopico2Tab4Es">
                                </div>
                                <div class="form-group ml-4">
                                    <label for="txtTopico3Tab4Es">Tópico 3 Tab 4 Espanhol</label>
                                    <input type="input" class="form-control" name="txtTopico3Tab4Es" id="txtTopico3Tab4Es">
                                </div>
                                <div class="form-group ml-4">
                                    <label for="txtTopico4Tab4Es">Tópico 4 Tab 4 Espanhol</label>
                                    <input type="input" class="form-control" name="txtTopico4Tab4Es" id="txtTopico4Tab4Es">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group ml-4">
                                    <label for="txtTopico5Tab4Es">Tópico 5 Tab 4 Espanhol</label>
                                    <input type="input" class="form-control" name="txtTopico5Tab4Es" id="txtTopico5Tab4Es">
                                </div>
                                <div class="form-group ml-4">
                                    <label for="txtTopico6Tab4Es">Tópico 6 Tab 4 Espanhol</label>
                                    <input type="input" class="form-control" name="txtTopico6Tab4Es" id="txtTopico6Tab4Es">
                                </div>
                                <div class="form-group ml-4">
                                    <label for="txtTopico7Tab4Es">Tópico 7 Tab 4 Espanhol</label>
                                    <input type="input" class="form-control" name="txtTopico7Tab4Es" id="txtTopico7Tab4Es">
                                </div>
                                <div class="form-group ml-4">
                                    <label for="txtTopico8Tab4Es">Tópico 8 Tab 4 Espanhol</label>
                                    <input type="input" class="form-control" name="txtTopico8Tab4Es" id="txtTopico8Tab4Es">
                                </div>
                            </div>
                        </div>
                    </div>

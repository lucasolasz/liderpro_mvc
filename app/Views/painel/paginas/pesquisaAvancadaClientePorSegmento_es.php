<div class="container mb-5">
    ...
    <div class="row d-flex justify-content-start mt-5">
        ...
        <div class="col-md-6 d-flex justify-content-end align-items-center">
            <div class="input-group">
                <input type="text" class="form-control" placeholder="Buscar por nombre de empresa" id="pesquisarClienteSegmento">
    ...
    <div class="row mt-5">
        ...
        <div class="col-md-8 lp-container-logos-avancado m-3 overflow-auto" id="divResultadoAjaxPorSegmento">
            <p style="color: gray;" class="p-3">Elige un segmento</p>
        </div>
    </div>

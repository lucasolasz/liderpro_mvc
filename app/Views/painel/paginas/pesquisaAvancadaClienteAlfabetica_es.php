<div class="container mb-5">
    ...
    <div class="row d-flex justify-content-start mt-5">
        <div class="col-md-6 d-flex flex-row">
            <div class="row">
                <div class="col">
                    <a class="btn d-flex justify-content-center align-items-center lp-btn-liderpro-info m-2 <?= $dados['tituloBreadcrumb'] == 'ordemAlfabetica' ? 'lp-btn-liderpro-info-active' : ''; ?>" href="<?= URL . '/Paginas/pesquisaAvancadaClienteAlfabetica' ?>" role="button">EN ORDEN ALFABÉTICO</a>
                </div>
                <div class="col">
                    <a class="btn d-flex justify-content-center align-items-center lp-btn-liderpro-info m-2 <?= $dados['tituloBreadcrumb'] == 'ordemSegmento' ? 'lp-btn-liderpro-info-active' : ''; ?>" href="<?= URL . '/Paginas/pesquisaAvancadaClientePorSegmento' ?>" role="button">POR ORDEN DE SEGMENTO</a>
                </div>
            </div>
        </div>
        <div class="col-md-6 d-flex justify-content-end align-items-center">
            <div class="input-group">
                <input type="text" class="form-control" id="pesquisarClienteAlfabeto" placeholder="Buscar por nombre de empresa">
    ...
    <div class="d-flex flex-column mt-5">
        ...
        <div class="lp-container-logos-avancado overflow-auto" id="divResultadoAjaxAlfabetica">
            <p style="color: gray;" class="p-3">Elija una opción de filtro</p>
        </div>
    </div>

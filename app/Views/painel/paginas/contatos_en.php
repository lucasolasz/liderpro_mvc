    ...
    <div class="row">
        <div class="col-md-6 col-lg-6 p-5">
            <div class="d-flex flex-column ">
                <div class="p-2 d-flex justify-content-center">
                    <p class="lp-paragrafo-sublinhado">SEND EMAIL</p>
                </div>
                <form name="emailContato" id="emailContato" method="POST" action="<?= URL ?>/EnvioEmail/enviarEmailContatos" enctype="multipart/form-data">
                    <div class="p-2">
                        ...
                        <div class="form__group field w-100">
                            <label for="txtDestinatario" class="form__label">For* </label>
                        ...
                        <div class="form__group field w-100">
                            ...
                            <label for="txtAssunto" class="form__label">Subject* </label>
                        </div>

                        <div class="form-group mt-3">
                            <label for="txtMensagemEmail" class="label-mensagem">Message*</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-6 d-flex justify-content-center py-2">
                            ...
                            <label for="fileAnexoContato" class="lp-botao-anexo">Attach Files</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col d-flex justify-content-end pr-5 py-2" id="fileCount">0 file(s) selected</div>
                    </div>

                    <div class="row py-2">
                        <div class="col d-flex justify-content-center">
                            <button class="lp-botao-enviar" role="button" id="btnEnviaContato">TO SEND</button>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="col-md-6 col-lg-6 p-5">
            ...
            <div class="row">
                ...
                <div class="col-md-11 col-lg-11">
                    <p class="lp-paragrafo">From Monday to Friday, from 8:30 am to 6 pm.</p>
                </div>
            </div>
            ...
            <div class="row py-5 mt-5">
                <div class="col">
                    <p class="lp-paragrafo d-flex justify-content-center">HOW TO GET TO LIDERPRO?</p>
                </div>

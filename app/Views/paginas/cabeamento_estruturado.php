<div class="container p-5">
    ...
    <div class="row py-5 d-flex align-items-center">
        <div class="col-md">
            <img class="img-fluid" src="<?= URL . '/img/paginas/cabeamento_estruturado/cabeamento_estruturado_pergunta1.png' ?>" alt="">
        </div>
        <div class="col-md py-5">
            <img class="img-fluid" src="<?= URL . '/img/paginas/cabeamento_estruturado/cabeamento_estruturado_pergunta2.png' ?>" alt="">
        </div>
        <div class="col-md">
            <img class="img-fluid" src="<?= URL . '/img/paginas/cabeamento_estruturado/cabeamento_estruturado_pergunta3.png' ?>" alt="">
        </div>
    </div>

    <div class="row">
        <div class="col-md-9 col-lg-9 d-flex align-items-center">
            <p class="lp-paragrafo "> Transformamos a tradicional estruturado de rede em uma solução de infraestrutura digital que engloba tecnologias inovadoras a atender novos recursos habilitados por hiperconvergência, virtualização e nuvem, tornando-a mais eficiente e flexível a demanda que estar por vir.
                Desenvolvemos e executamos projetos de rede estruturada em cabeamento UTP nas categorias 5e, 6, 6A e 7, além de fibra óptica. Respeitando estritamente as normas nacional NBR 16.665 e internacionais ANSI/TIA/EIA/ISO/IEEE, que suportam diversas tecnologias, dispositivos, recursos e demanda, atendendo de grupo de trabalho aos maiores requisitos corporativos para tráfego de internet, dados, imagem e voz. <a class="ml-2 lp-link-veja-mais" href="#">VEJA +</a>
            </p>
        </div>
        <div class="col-md-3 col-lg-3 d-flex justify-content-center">
            <img class="img-fluid" style="height: 200px; width: 180px" src="<?= URL . '/img/paginas/cabeamento_estruturado/imagem_texto_cabeamento_estruturado.png' ?>" alt="">
        </div>
    </div>
